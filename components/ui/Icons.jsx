...
export function IconOrders({ className = 'w-5 h-5' }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.75}>
...
export function IconProducts({ className = 'w-5 h-5' }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.75}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M7 7h.01M7 3h5c.512 0 .953.343 1.087.835l.973 3.89A2 2 0 0016.138 9H19a2 2 0 011.994 2.18l-1 9A2 2 0 0117.006 22H7a2 2 0 01-1.994-1.82l-1-9A2 2 0 005 11h2.862a2 2 0 001.995-1.275l.973-3.89A1 1 0 0112 3z" />
    </svg>
  );
}

export function IconWorkers({ className = 'w-5 h-5' }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.75}>
...
export function IconQC({ className = 'w-5 h-5' }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.75}>
...
export function IconPackage({ className = 'w-12 h-12' }) {
  return (
...
export function IconLeaf({ className = 'w-8 h-8' }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M5 19c0-4 4-8 9-8 1 0 3 0 5-2-2 5-6 7-10 7-2 0-4 0-4-3z" />
    </svg>
  );
}
...
export function IconVolume({ className = 'w-5 h-5' }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.75}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M15.536 8.464a5 5 0 010 7.072M12 6l-4 4H4v4h4l4 4V6zm7.07 2.93a9 9 0 010 12.728" />
    </svg>
  );
}
